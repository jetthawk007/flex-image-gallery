...
const Fotorama = function ($fotorama, opts) {
  ...
  var fotorama = $fotorama[0],
      ...
      $anchor = $(div(globalClasses.hiddenClass)),
      $wrap = $(div(globalClasses.wrapClass)),
      $stage = $(div(globalClasses.stageClass)).appendTo($wrap),

      $stageShaft = $(div(globalClasses.stageShaftClass)).appendTo($stage),
      $stageFrame = $(),
      $arrPrev = $(div(globalClasses.arrClass + ' ' + globalClasses.arrPrevClass + globalClasses.buttonAttributes)),
      $arrNext = $(div(globalClasses.arrClass + ' ' + globalClasses.arrNextClass + globalClasses.buttonAttributes)),
      $arrs = $arrPrev.add($arrNext).appendTo($stage),
      $navWrap = $(div(globalClasses.navWrapClass)),
      $nav = $(div(globalClasses.navClass)).appendTo($navWrap),
      $navShaft = $(div(globalClasses.navShaftClass)).appendTo($nav),
      $navFrame,
      $navDotFrame = $(),
      $navThumbFrame = $(),

      $thumbBorder = $(div(globalClasses.thumbBorderClass)).appendTo($navShaft),

      $fullscreenIcon = $(div(globalClasses.fullscreenIconClass + globalClasses.buttonAttributes)),
